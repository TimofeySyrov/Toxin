...
module.exports = {
  ...
  entry: {
    ...
    cards: ['./pages/cards/index.js'],
    'search-room': ['./pages/search-room/index.js'],
    'room-details': ['./pages/room-details/index.js'],
    'sign-in': ['./pages/sign-in/index.js'],
    'sign-up': ['./pages/sign-up/index.js'],
    'colors-type': ['./pages/colors-type/index.js'],
    'form-elements': ['./pages/form-elements/index.js'],
    'headers-footers': ['./pages/headers-footers/index.js'],
  },
  output: {
